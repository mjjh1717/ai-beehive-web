...
export default {
  ...
  chat: {
    defaultName: '说文',
    newChatButton: '新建聊天',
    placeholder: '来说点什么吧（Shift + Enter = 换行，下载提示词后输入"/" 触发）',
    systemRoleTitle: ' 温柔地指挥助手，设定助手的行为。(此处设置提示词后,不需要在输入中再次设置)',
    systemRoleplaceholder: '你是一个乐于助人的助手，尽量简明扼要的回答....(输入/触发提示词）',
    placeholderMobile: '来说点什么(下载提示词后输入"/" 触发)',
    copy: '复制',
    copied: '复制成功',
    copyCode: '复制代码',
    clearChat: '清空会话',
